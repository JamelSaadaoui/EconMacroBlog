...
*FIGURE ONE
scatter CABPMA20 TARSMA20 if YEAR==2022, colorvar(USCOLOR) clegend(off) || line CABPSP TARSMA20 if YEAR==2022, ytitle("Current account balance, percent of GDP") legend(off) saving("FIGURE1.gph",replace) name(FIGURE1, replace)
...
*FIGURE TWO
scatter CABPMA20 FISCPMA20 if YEAR==2022, colorvar(USCOLOR) clegend(off) || line CABPFP FISCPMA20 if YEAR==2022, ytitle("Current account balance, percent of GDP") legend(off) saving("FIGURE2.gph",replace)
scatter NXGPMA20 FISCPMA20 if YEAR==2022, colorvar(USCOLOR) clegend(off) || line NXGPFP FISCPMA20 if YEAR==2022, ytitle("Net exports of goods, percent of GDP") legend(off) saving("NXGFMA20.gph",replace)

*Drop observations not in figure because they distort the x-axis range
drop if DRESPMA20>10

scatter NXGPMA20 DRESPMA20 if YEAR==2022, colorvar(USCOLOR) clegend(off) || line NXGPRP DRESPMA20 if YEAR==2022, ytitle("Net exports of goods, percent of GDP") legend(off) saving("NXGRMA20.gph",replace)
*FIGURE THREE
scatter CABPMA20 DRESPMA20 if YEAR==2022, colorvar(USCOLOR) clegend(off) || line CABPRP DRESPMA20 if YEAR==2022, ytitle("Current account balance, percent of GDP") legend(off) saving("FIGURE3.gph",replace)
